...
class _ListaComodoImoveisState extends State<ListaComodoImoveis> {
  ...
  int idGrupoMedidas = FieldsGrupoMedidas.idGrupoMedidas;
  ...
  Future<dynamic> alterarStatus() async {
    int idRegistro = FieldsGrupoMedidas.idGrupoMedidas;
...
// ==== MENSAGEM QUE DISPARA PARA EDITAR O GRUPO DE MEDIDAS =====
  popupEdicaoMedida(idGrupoMedidas) {
    MsgPopup().msgComDoisBotoes(
      context,
  ...
  mostrarSpeedDial() {
    if (FieldsGrupoMedidas.statusGProcesso == 'Cadastrado' ||
        FieldsGrupoMedidas.statusGProcesso == 'Finalizado')
      return SpeedDial(
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      // FieldsGrupoMedidas.statusGrupo == 'Cadastrado' ?
      ...
      body: Container(
        ...
        child: Column(
          children: [
            Cabecalho().tituloCabecalho(context, 'Medidas cadastradas',
                iconeVoltar: true),
            Padding(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                    ...
                    color: Colors.white),
                child: FutureBuilder(
                  future: listaComodosImovel(FieldsGrupoMedidas.idGrupoMedidas),
                                    ...
                                    onDoubleTap: () {
                                      Navigator.push(
                                        ...
                                        MaterialPageRoute(
                                          builder: (context) =>
                                              ListaDadosComodo(
                                            idMedidaUnt: dadosListagem[index]
                                                .idMedidaUnt,
                                          ),
                                        ),
                                      );
